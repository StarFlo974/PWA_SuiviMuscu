...
export class ApiService {
  private apiExerciseUrl = 'http://localhost:8000/api/exercises';
  private apiSessionUrl = 'http://localhost:8000/api/sessions';
  private apiCategorieUrl = 'http://localhost:8000/api/categories';
